...
syn keyword elixirLangImport import
syn keyword elixirLangRequire require
...
" Declarations
syn match  elixirModuleDeclaration          "[^[:space:];#<,()\[\]]\+" contained                      nextgroup=elixirBlock     skipwhite skipnl contains=elixirDot
